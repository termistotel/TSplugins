require("ts3init")
unrequire("DJ-Placeholder/main/treee")
require("DJ-Placeholder/main/treee")


local songLoc = ts3.getPluginPath().."lua_plugin/DJ-Placeholder/main/pjesme"
local plugLoc = ts3.getPluginPath().."lua_plugin/DJ-Placeholder/main"
local dirLoc = ts3.getPluginPath().."lua_plugin/DJ-Placeholder"
...
ts3RegisterModule("main", registeredEvents)
